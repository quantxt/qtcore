...
public class State {
     ...
     */
    private TreeMap<String, Object> emits;
    ...
    public void addEmit(String keyword) {
        if (this.emits == null) {
            this.emits = new TreeMap<>();
        }
        this.emits.put(keyword, null);
    }

    public void addEmit(String keyword, Object customData) {
        if (this.emits == null) {
            this.emits = new TreeMap<>();
        }
        this.emits.put(keyword, customData);
    }

    public void addEmit(Map<String, Object> emits) {
        if (this.emits == null) {
            this.emits = new TreeMap<>();
        }
        this.emits.putAll(emits);
    }

    public Map<String, Object> emit() {
        return this.emits == null ? new TreeMap<String, Object>() : this.emits;
    }
